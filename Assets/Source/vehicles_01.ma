...
//Name: vehicles_01.ma
//Last modified: Fri, Oct 18, 2013 07:22:25 AM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.32413447250725735 0.50263767447807994 1.4586566180649494 ;
	setAttr ".r" -type "double3" -14.138352724790041 31.799999999998494 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 1.506964929316382;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -0.48047215334595239 0.066921913623809809 0.275 ;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.10038580933833 0.12130532562732696 0.2500000000000222 ;
...
createNode mesh -n "pasted__turretShape" -p "pasted__turret";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.49999999266583472 0.46924331109039485 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 26 ".pt";
	setAttr ".pt[16]" -type "float3" 0 -0.042105522 -0.079207018 ;
	setAttr ".pt[17]" -type "float3" 0 0.042105522 0.079207055 ;
	setAttr ".pt[18]" -type "float3" 0 -0.042105522 0.079207011 ;
	setAttr ".pt[19]" -type "float3" 0 0.042105522 -0.079207055 ;
	setAttr ".pt[20]" -type "float3" 8.8817842e-016 0.061866891 -0.072619341 ;
	setAttr ".pt[21]" -type "float3" 8.8817842e-016 -0.0015944497 -0.096840873 ;
	setAttr ".pt[22]" -type "float3" 8.8817842e-016 -0.065055691 -0.072619341 ;
	setAttr ".pt[23]" -type "float3" 8.8817842e-016 -0.094638586 5.8640199e-009 ;
	setAttr ".pt[24]" -type "float3" 8.8817842e-016 -0.065055691 0.072619274 ;
	setAttr ".pt[25]" -type "float3" 8.8817842e-016 -0.0015944497 0.096840881 ;
	setAttr ".pt[26]" -type "float3" 8.8817842e-016 0.061866891 0.072619274 ;
	setAttr ".pt[27]" -type "float3" 8.8817842e-016 0.09144967 5.8640199e-009 ;
	setAttr ".pt[28]" -type "float3" 0 0.031497203 -0.079207018 ;
	setAttr ".pt[29]" -type "float3" 0 -0.036159519 -0.079207018 ;
	setAttr ".pt[30]" -type "float3" 0 -0.0015944 -0.02374441 ;
	setAttr ".pt[31]" -type "float3" 0 -0.024407936 3.0216207e-009 ;
	setAttr ".pt[32]" -type "float3" 0 -0.017154507 -0.017805584 ;
	setAttr ".pt[33]" -type "float3" 0 -0.036159519 0.079207018 ;
	setAttr ".pt[34]" -type "float3" 0 -0.0015944 0.02374441 ;
	setAttr ".pt[35]" -type "float3" 0 -0.017154507 0.017805578 ;
	setAttr ".pt[36]" -type "float3" 0 0.031497203 0.079207018 ;
	setAttr ".pt[37]" -type "float3" 0 0.021219155 3.0216207e-009 ;
	setAttr ".pt[38]" -type "float3" 0 0.013965737 0.017805578 ;
	setAttr ".pt[39]" -type "float3" 0 0.013965737 -0.017805584 ;
...
createNode mesh -n "pasted__treadsShape" -p "pasted__treads";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" -0.34846305847167969 0.257679283618927 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode mesh -n "pasted__chassisShape" -p "pasted__chassis";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.47320087079424411 0.50000001874286681 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode polyAutoProj -n "polyAutoProj2";
	...
	setAttr ".ix" -type "matrix" 0.20000000000000001 0 0 0 0 0.20000000000000001 0 0
		 0 0 0.20000000000000001 0 -0.081493741353129784 0.012133878469467107 0 1;
	setAttr ".s" -type "double3" 1.1229875208532469 1.1229875208532469 1.1229875208532469 ;
	setAttr ".ps" 0.20000000298023224;
	setAttr ".dl" yes;
...
createNode polyAutoProj -n "polyAutoProj4";
	...
	setAttr ".ics" -type "componentList" 1 "f[0:27]";
	setAttr ".ix" -type "matrix" 0.20000000000000001 0 0 0 0 0.20000000000000001 0 0
		 0 0 0.20000877581487833 0 -0.018777912775884035 -5.9604644775390628e-009 0 1;
	setAttr ".s" -type "double3" 1.1229875208532469 1.1229875208532469 1.1229875208532469 ;
	setAttr ".ps" 0.20000000298023224;
	setAttr ".dl" yes;
createNode blinn -n "blinn2";
createNode file -n "file2";
	setAttr ".ftn" -type "string" "C:/Users/alteveer/Projects/tanx/Assets/Source/camo_green_tank.psd";
...
createNode polyTweakUV -n "polyTweakUV9";
	setAttr ".uopa" yes;
	setAttr -s 49 ".uvtk";
	setAttr ".uvtk[32]" -type "float2" -0.45892906 1.0895048 ;
	setAttr ".uvtk[33]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[34]" -type "float2" -0.45892906 1.0895048 ;
	setAttr ".uvtk[35]" -type "float2" -0.45892906 1.0895047 ;
	setAttr ".uvtk[36]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[37]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[38]" -type "float2" -0.458929 1.0895048 ;
	setAttr ".uvtk[39]" -type "float2" -0.45892903 1.089505 ;
	setAttr ".uvtk[40]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[41]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[42]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[43]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[44]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[45]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[46]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[47]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[48]" -type "float2" -0.45892903 1.089505 ;
	setAttr ".uvtk[49]" -type "float2" -0.45892903 1.0895047 ;
	setAttr ".uvtk[50]" -type "float2" -0.45892906 1.089505 ;
	setAttr ".uvtk[51]" -type "float2" -0.45892903 1.089505 ;
	setAttr ".uvtk[52]" -type "float2" -0.45892903 1.0895047 ;
	setAttr ".uvtk[53]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[54]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[55]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[88]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[89]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[90]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[91]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[92]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[93]" -type "float2" -0.45892903 1.089505 ;
	setAttr ".uvtk[94]" -type "float2" -0.45892903 1.0895047 ;
	setAttr ".uvtk[95]" -type "float2" -0.45892903 1.089505 ;
	setAttr ".uvtk[96]" -type "float2" -0.45892903 1.089505 ;
	setAttr ".uvtk[97]" -type "float2" -0.45892903 1.0895047 ;
	setAttr ".uvtk[98]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[99]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[100]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[101]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[102]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[103]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[104]" -type "float2" -0.45892903 1.0895047 ;
	setAttr ".uvtk[105]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[106]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[107]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[108]" -type "float2" -0.45892903 1.089505 ;
	setAttr ".uvtk[109]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[110]" -type "float2" -0.45892903 1.0895048 ;
	setAttr ".uvtk[111]" -type "float2" -0.45892903 1.0895048 ;
...
createNode polyTweakUV -n "polyTweakUV10";
	setAttr ".uopa" yes;
	setAttr -s 60 ".uvtk";
	setAttr ".uvtk[0]" -type "float2" -0.88260549 -0.1660424 ;
	setAttr ".uvtk[1]" -type "float2" -0.93912011 -0.1347307 ;
	setAttr ".uvtk[2]" -type "float2" -1.0017434 -0.24775997 ;
	setAttr ".uvtk[3]" -type "float2" -0.94522887 -0.27907157 ;
	setAttr ".uvtk[4]" -type "float2" -0.15436313 -0.71724731 ;
	setAttr ".uvtk[5]" -type "float2" -0.091740094 -0.60421813 ;
	setAttr ".uvtk[6]" -type "float2" -0.072441332 -0.76263577 ;
	setAttr ".uvtk[7]" -type "float2" -0.0098182317 -0.64960647 ;
	setAttr ".uvtk[8]" -type "float2" -0.012136107 -0.79604751 ;
	setAttr ".uvtk[9]" -type "float2" 0.05048725 -0.68301851 ;
	setAttr ".uvtk[10]" -type "float2" 0.2105597 -0.77170587 ;
	setAttr ".uvtk[11]" -type "float2" 0.14793596 -0.88473481 ;
	setAttr ".uvtk[13]" -type "float2" 0.20448175 -0.91606396 ;
	setAttr ".uvtk[14]" -type "float2" 0.26710561 -0.80303526 ;
	setAttr ".uvtk[16]" -type "float2" 0.32133988 -0.83308405 ;
	setAttr ".uvtk[17]" -type "float2" 0.25871599 -0.94611287 ;
	setAttr ".uvtk[18]" -type "float2" 0.23730956 -0.60323304 ;
	setAttr ".uvtk[19]" -type "float2" 0.29382411 -0.63454479 ;
	setAttr ".uvtk[20]" -type "float2" 0.35644743 -0.52151555 ;
	setAttr ".uvtk[21]" -type "float2" 0.29993293 -0.49020392 ;
	setAttr ".uvtk[22]" -type "float2" -0.80490428 -0.025798973 ;
	setAttr ".uvtk[23]" -type "float2" -0.7422809 0.087230191 ;
	setAttr ".uvtk[24]" -type "float2" -0.86141878 0.0055126902 ;
	setAttr ".uvtk[25]" -type "float2" -0.7987954 0.11854181 ;
	setAttr ".uvtk[26]" -type "float2" -0.92785567 0.042321641 ;
	setAttr ".uvtk[29]" -type "float2" -0.86523229 0.15535092 ;
	setAttr ".uvtk[30]" -type "float2" -0.99429268 0.079130739 ;
	setAttr ".uvtk[31]" -type "float2" -0.93166929 0.19215997 ;
	setAttr ".uvtk[56]" -type "float2" 0.41817033 0.62725562 ;
	setAttr ".uvtk[57]" -type "float2" 0.41817045 0.62725562 ;
	setAttr ".uvtk[58]" -type "float2" 0.41817045 0.62725562 ;
	setAttr ".uvtk[59]" -type "float2" 0.41817033 0.62725562 ;
	setAttr ".uvtk[60]" -type "float2" 0.41817033 0.62725562 ;
	setAttr ".uvtk[61]" -type "float2" 0.41817045 0.62725562 ;
	setAttr ".uvtk[62]" -type "float2" 0.41817033 0.62725556 ;
	setAttr ".uvtk[63]" -type "float2" 0.41817045 0.62725556 ;
	setAttr ".uvtk[64]" -type "float2" 0.41817033 0.62725562 ;
	setAttr ".uvtk[65]" -type "float2" 0.41817045 0.62725562 ;
	setAttr ".uvtk[66]" -type "float2" 0.41817033 0.62725562 ;
	setAttr ".uvtk[67]" -type "float2" 0.41817045 0.62725562 ;
	setAttr ".uvtk[68]" -type "float2" 0.41817033 0.62725562 ;
	setAttr ".uvtk[69]" -type "float2" 0.41817033 0.62725556 ;
	setAttr ".uvtk[70]" -type "float2" 0.41817039 0.62725556 ;
	setAttr ".uvtk[71]" -type "float2" 0.41817039 0.62725562 ;
	setAttr ".uvtk[72]" -type "float2" 0.41817039 0.62725556 ;
	setAttr ".uvtk[73]" -type "float2" 0.41817039 0.62725562 ;
	setAttr ".uvtk[74]" -type "float2" 0.41817033 0.62725568 ;
	setAttr ".uvtk[75]" -type "float2" 0.41817039 0.62725568 ;
	setAttr ".uvtk[76]" -type "float2" 0.41817039 0.62725556 ;
	setAttr ".uvtk[77]" -type "float2" 0.41817033 0.62725556 ;
	setAttr ".uvtk[78]" -type "float2" 0.41817033 0.62725562 ;
	setAttr ".uvtk[79]" -type "float2" 0.41817039 0.62725562 ;
	setAttr ".uvtk[80]" -type "float2" 0.41817033 0.62725562 ;
	setAttr ".uvtk[81]" -type "float2" 0.41817039 0.62725562 ;
	setAttr ".uvtk[82]" -type "float2" 0.41817039 0.62725562 ;
	setAttr ".uvtk[83]" -type "float2" 0.41817045 0.62725562 ;
	setAttr ".uvtk[84]" -type "float2" 0.41817045 0.62725562 ;
	setAttr ".uvtk[85]" -type "float2" 0.41817039 0.62725562 ;
	setAttr ".uvtk[86]" -type "float2" 0.41817039 0.62725562 ;
	setAttr ".uvtk[87]" -type "float2" 0.41817045 0.62725562 ;
...
createNode polyTweakUV -n "polyTweakUV11";
	setAttr ".uopa" yes;
	setAttr -s 26 ".uvtk";
	setAttr ".uvtk[0]" -type "float2" -0.11232668 0.13476875 ;
	setAttr ".uvtk[1]" -type "float2" 0.0056168847 0.13476868 ;
	setAttr ".uvtk[2]" -type "float2" 0.0056168623 0.37065583 ;
	setAttr ".uvtk[3]" -type "float2" -0.11232658 0.37065572 ;
	setAttr ".uvtk[4]" -type "float2" -1.7628287 0.37065592 ;
	setAttr ".uvtk[5]" -type "float2" -1.7628281 0.13476887 ;
	setAttr ".uvtk[6]" -type "float2" -1.9337962 0.37065598 ;
	setAttr ".uvtk[7]" -type "float2" -1.9337959 0.13476875 ;
	setAttr ".uvtk[8]" -type "float2" -2.0596504 0.37065548 ;
	setAttr ".uvtk[9]" -type "float2" -2.0596507 0.13476901 ;
	setAttr ".uvtk[10]" -type "float2" -2.3937147 0.13476856 ;
	setAttr ".uvtk[11]" -type "float2" -2.3937135 0.37065569 ;
	setAttr ".uvtk[13]" -type "float2" -2.511723 0.37065631 ;
	setAttr ".uvtk[14]" -type "float2" -2.511724 0.13476944 ;
	setAttr ".uvtk[16]" -type "float2" -2.6249092 0.13477018 ;
	setAttr ".uvtk[17]" -type "float2" -2.6249077 0.37065738 ;
	setAttr ".uvtk[18]" -type "float2" 2.575917 0.13476951 ;
	setAttr ".uvtk[19]" -type "float2" 2.6938603 0.13476926 ;
	setAttr ".uvtk[20]" -type "float2" 2.6938603 0.37065631 ;
	setAttr ".uvtk[21]" -type "float2" 2.575917 0.37065619 ;
	setAttr ".uvtk[22]" -type "float2" 0.4008621 0.13476904 ;
	setAttr ".uvtk[23]" -type "float2" 0.40086225 0.37065592 ;
	setAttr ".uvtk[24]" -type "float2" 0.28291878 0.13476899 ;
	setAttr ".uvtk[25]" -type "float2" 0.28291893 0.37065583 ;
	setAttr ".uvtk[26]" -type "float2" 0.14426799 0.13476871 ;
	setAttr ".uvtk[29]" -type "float2" 0.14426799 0.37065592 ;
createNode polySoftEdge -n "polySoftEdge14";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 2 "e[23]" "e[30:32]";
	setAttr ".ix" -type "matrix" 0.20000000000000001 0 0 0 0 0.20000000000000001 0 0
		 0 0 0.20000000000000001 0 -0.018777912775884035 -5.9604644775390628e-009 0 1;
	setAttr ".a" 0;
createNode polySoftEdge -n "polySoftEdge15";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 3 "e[0:19]" "e[30:31]" "e[33:34]";
	setAttr ".ix" -type "matrix" 0.20000000000000001 0 0 0 0 0.20000000000000001 0 0
		 0 0 0.20000000000000001 0 -0.018777912775884035 -5.9604644775390628e-009 0 1;
	setAttr ".a" 0;
createNode polySoftEdge -n "polySoftEdge16";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 3 "e[20:29]" "e[32]" "e[35]";
	setAttr ".ix" -type "matrix" 0.20000000000000001 0 0 0 0 0.20000000000000001 0 0
		 0 0 0.20000000000000001 0 -0.018777912775884035 -5.9604644775390628e-009 0 1;
	setAttr ".a" 180;
...
createNode polyExtrudeFace -n "polyExtrudeFace2";
	...
	setAttr ".ix" -type "matrix" 0.20000000000000001 0 0 0 0 0.20000000000000001 0 0
		 0 0 0.20000000000000001 0 -0.018777912775884035 -5.9604644775390628e-009 0 1;
	setAttr ".ws" yes;
	setAttr ".pvt" -type "float3" 0.031357914 0.12130532 0.30000001 ;
	setAttr ".rs" 34168;
	setAttr ".off" 0.019999999552965164;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -0.49877793184937036 -1.1920928955078126e-008 0.30000000000000004 ;
	setAttr ".cbx" -type "double3" 0.56149376042663068 0.24261066317558289 0.30000000000000004 ;
createNode polyExtrudeFace -n "polyExtrudeFace3";
	setAttr ".ics" -type "componentList" 1 "f[11]";
	setAttr ".ix" -type "matrix" 0.20000000000000001 0 0 0 0 0.20000000000000001 0 0
		 0 0 0.20000000000000001 0 -0.018777912775884035 -5.9604644775390628e-009 0 1;
	setAttr ".ws" yes;
	setAttr ".pvt" -type "float3" 0.031755812 0.12127314 0.30000001 ;
	setAttr ".rs" 34018;
	setAttr ".lt" -type "double3" 0 0 -0.025341180644137817 ;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -0.47695285669983423 0.019999986886978151 0.30000000000000004 ;
	setAttr ".cbx" -type "double3" 0.5404644788104197 0.22254628539085389 0.30000000000000004 ;
createNode deleteComponent -n "deleteComponent16";
	setAttr ".dc" -type "componentList" 2 "f[11]" "f[28:51]";
createNode deleteComponent -n "deleteComponent17";
	setAttr ".dc" -type "componentList" 1 "f[10]";
createNode polyExtrudeEdge -n "polyExtrudeEdge12";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 3 "e[10:19]" "e[31]" "e[34]";
	setAttr ".ix" -type "matrix" 0.20000000000000001 0 0 0 0 0.20000000000000001 0 0
		 0 0 0.20000000000000001 0 -0.018777912775884035 -5.9604644775390628e-009 0 1;
	setAttr ".ws" yes;
	setAttr ".pvt" -type "float3" 0.031357914 0.12130532 0.30000001 ;
	setAttr ".rs" 34415;
	setAttr ".lt" -type "double3" 2.1770779623508929e-016 -2.2420340595430802e-016 -0.017396132793466936 ;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -0.49877793184937036 -1.1920928955078126e-008 0.30000000000000004 ;
	setAttr ".cbx" -type "double3" 0.56149376042663068 0.24261066317558289 0.30000000000000004 ;
createNode polyNormalizeUV -n "polyNormalizeUV1";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 1 "f[26:37]";
	setAttr ".ix" -type "matrix" 0.20000000000000001 0 0 0 0 0.20000000000000001 0 0
		 0 0 0.20000000000000001 0 -0.018777912775884035 -5.9604644775390628e-009 0 1;
	setAttr ".pa" no;
createNode polyAutoProj -n "polyAutoProj5";
	...
	setAttr ".ix" -type "matrix" 0.20000000000000001 0 0 0 0 0.20000000000000001 0 0
		 0 0 0.20000000000000001 0 -0.018777912775884035 -5.9604644775390628e-009 0 1;
	setAttr ".s" -type "double3" 1.0602716922760012 1.0602716922760012 1.0602716922760012 ;
	setAttr ".ps" 0.20000000298023224;
	setAttr ".dl" yes;
createNode polyTweakUV -n "polyTweakUV12";
	setAttr ".uopa" yes;
	setAttr -s 25 ".uvtk";
	setAttr ".uvtk[82]" -type "float2" 0.12841085 -1.3496801 ;
	setAttr ".uvtk[83]" -type "float2" 0.12841085 -1.3496801 ;
	setAttr ".uvtk[84]" -type "float2" 0.12841085 -1.3496801 ;
	setAttr ".uvtk[85]" -type "float2" 0.12841085 -1.3496801 ;
	setAttr ".uvtk[86]" -type "float2" 0.12841085 -1.3496801 ;
	setAttr ".uvtk[87]" -type "float2" 0.12841085 -1.3496801 ;
	setAttr ".uvtk[88]" -type "float2" 0.12841085 -1.3496801 ;
	setAttr ".uvtk[89]" -type "float2" 0.12841085 -1.3496801 ;
	setAttr ".uvtk[90]" -type "float2" 0.12841085 -1.3496801 ;
	setAttr ".uvtk[91]" -type "float2" 0.12841085 -1.3496801 ;
	setAttr ".uvtk[92]" -type "float2" 0.12841085 -1.3496801 ;
	setAttr ".uvtk[93]" -type "float2" 0.12841085 -1.3496801 ;
	setAttr ".uvtk[94]" -type "float2" 0.12841085 -1.3496801 ;
	setAttr ".uvtk[95]" -type "float2" 0.12841085 -1.3496801 ;
	setAttr ".uvtk[96]" -type "float2" 0.12841085 -1.3496801 ;
	setAttr ".uvtk[97]" -type "float2" 0.12841085 -1.3496801 ;
	setAttr ".uvtk[98]" -type "float2" 0.12841085 -1.3496801 ;
	setAttr ".uvtk[99]" -type "float2" 0.12841085 -1.3496801 ;
	setAttr ".uvtk[100]" -type "float2" 0.12841085 -1.3496801 ;
	setAttr ".uvtk[101]" -type "float2" 0.12841085 -1.3496801 ;
	setAttr ".uvtk[102]" -type "float2" 0.12841085 -1.3496801 ;
	setAttr ".uvtk[103]" -type "float2" 0.12841085 -1.3496801 ;
	setAttr ".uvtk[104]" -type "float2" 0.12841085 -1.3496801 ;
	setAttr ".uvtk[105]" -type "float2" 0.12841085 -1.3496801 ;
createNode polyMapCut -n "polyMapCut3";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 4 "e[10:19]" "e[31]" "e[34]" "e[72:95]";
...
createNode polyTweakUV -n "polyTweakUV13";
	setAttr ".uopa" yes;
	setAttr -s 50 ".uvtk";
	setAttr ".uvtk[0]" -type "float2" 0.031290889 0 ;
	setAttr ".uvtk[1]" -type "float2" -0.00078031421 0 ;
	setAttr ".uvtk[5]" -type "float2" -0.029391885 0 ;
	setAttr ".uvtk[7]" -type "float2" -0.0018641949 0 ;
	setAttr ".uvtk[8]" -type "float2" -0.00068318844 0 ;
	setAttr ".uvtk[10]" -type "float2" -0.00074112415 0 ;
	setAttr ".uvtk[14]" -type "float2" 0.00018465519 0 ;
	setAttr ".uvtk[16]" -type "float2" -0.0026082993 0 ;
	setAttr ".uvtk[18]" -type "float2" 0.042609453 0 ;
	setAttr ".uvtk[19]" -type "float2" 0.0027474165 0 ;
	setAttr ".uvtk[22]" -type "float2" -0.042328484 0 ;
	setAttr ".uvtk[25]" -type "float2" -0.0002468992 0 ;
	setAttr ".uvtk[26]" -type "float2" -7.4505806e-009 0 ;
	setAttr ".uvtk[82]" -type "float2" -0.007285893 -0.00033505168 ;
	setAttr ".uvtk[83]" -type "float2" -0.010674357 -0.0025633695 ;
	setAttr ".uvtk[84]" -type "float2" 0.10115843 -0.00033505168 ;
	setAttr ".uvtk[85]" -type "float2" 0.010683507 -0.0024941778 ;
	setAttr ".uvtk[86]" -type "float2" -0.011185169 -0.0025188578 ;
	setAttr ".uvtk[87]" -type "float2" 0.011865139 -5.3565949e-005 ;
	setAttr ".uvtk[88]" -type "float2" -0.0084728003 -0.00048974343 ;
	setAttr ".uvtk[89]" -type "float2" 0.011880882 -0.0014877068 ;
	setAttr ".uvtk[90]" -type "float2" -0.13551319 -0.00022658333 ;
	setAttr ".uvtk[91]" -type "float2" 0.0080679655 -0.0005914066 ;
	setAttr ".uvtk[92]" -type "float2" -0.013394386 -0.0035830084 ;
	setAttr ".uvtk[93]" -type "float2" 0.013641056 -0.0035828641 ;
	setAttr ".uvtk[94]" -type "float2" -0.013024271 -0.0024942141 ;
	setAttr ".uvtk[95]" -type "float2" 0.0072958469 -5.653128e-007 ;
	setAttr ".uvtk[96]" -type "float2" -0.01188083 -0.0014878633 ;
	setAttr ".uvtk[97]" -type "float2" 0.0085276775 -0.00022654142 ;
	setAttr ".uvtk[98]" -type "float2" -0.011036754 -0.0010569775 ;
	setAttr ".uvtk[99]" -type "float2" 0.0088129044 -0.0010567848 ;
	setAttr ".uvtk[100]" -type "float2" -0.0066127777 0 ;
	setAttr ".uvtk[101]" -type "float2" 0.13630128 -0.00048986729 ;
	setAttr ".uvtk[102]" -type "float2" -0.013660669 -0.00059128087 ;
	setAttr ".uvtk[103]" -type "float2" 0.011229277 -0.0025623431 ;
	setAttr ".uvtk[104]" -type "float2" -0.10004085 -5.3669326e-005 ;
	setAttr ".uvtk[105]" -type "float2" 0.011462927 -0.0025179908 ;
createNode polyMapSewMove -n "polyMapSewMove11";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 2 "e[0:35]" "e[72:95]";
	setAttr ".lps" yes;
createNode polyMergeUV -n "polyMergeUV1";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 5 "map[0:11]" "map[13:14]" "map[16:26]" "map[29]" "map[82:91]";
...
createNode polyTweakUV -n "polyTweakUV14";
	setAttr ".uopa" yes;
	setAttr -s 24 ".uvtk";
	setAttr ".uvtk[0]" -type "float2" -0.0080187591 0.11562073 ;
	setAttr ".uvtk[1]" -type "float2" -0.0080187591 0.11562075 ;
	setAttr ".uvtk[5]" -type "float2" -0.0080188485 0.11562074 ;
	setAttr ".uvtk[7]" -type "float2" -0.0080188485 0.11562075 ;
	setAttr ".uvtk[9]" -type "float2" -0.0080188485 0.11562074 ;
	setAttr ".uvtk[10]" -type "float2" -0.0080188485 0.11562074 ;
	setAttr ".uvtk[14]" -type "float2" -0.0080188485 0.11562075 ;
	setAttr ".uvtk[16]" -type "float2" -0.0080187591 0.11562075 ;
	setAttr ".uvtk[18]" -type "float2" -0.0080188485 0.11562075 ;
	setAttr ".uvtk[19]" -type "float2" -0.0080188485 0.11562074 ;
	setAttr ".uvtk[20]" -type "float2" -0.0080188485 0.11562074 ;
	setAttr ".uvtk[22]" -type "float2" -0.0080187479 0.11562074 ;
	setAttr ".uvtk[24]" -type "float2" -0.008018747 0.11562073 ;
	setAttr ".uvtk[26]" -type "float2" -0.0080187442 0.11562075 ;
	setAttr ".uvtk[82]" -type "float2" -0.0080187591 0.11562074 ;
	setAttr ".uvtk[83]" -type "float2" -0.0080188485 0.11562074 ;
	setAttr ".uvtk[84]" -type "float2" -0.008018747 0.11562074 ;
	setAttr ".uvtk[85]" -type "float2" -0.0080187591 0.11562074 ;
	setAttr ".uvtk[86]" -type "float2" -0.0080187591 0.11562074 ;
	setAttr ".uvtk[87]" -type "float2" -0.0080188485 0.11562074 ;
	setAttr ".uvtk[88]" -type "float2" -0.0080188485 0.11562074 ;
	setAttr ".uvtk[89]" -type "float2" -0.0080187442 0.11562074 ;
	setAttr ".uvtk[90]" -type "float2" -0.0080187479 0.11562074 ;
	setAttr ".uvtk[91]" -type "float2" -0.0080188485 0.11562074 ;
createNode polyChipOff -n "polyChipOff2";
	setAttr ".ics" -type "componentList" 1 "f[0:11]";
	setAttr ".ix" -type "matrix" 0.20000000000000001 0 0 0 0 0.20000000000000001 0 0
		 0 0 0.20000000000000001 0 -0.018777912775884035 -5.9604644775390628e-009 0 1;
	setAttr ".ws" yes;
	setAttr ".pvt" -type "float3" -0.018777912 -5.9604646e-009 0 ;
	setAttr ".rs" 42698;
	setAttr ".lt" -type "double3" -4.2500725161431774e-017 -2.4521254902129464e-018 
		-0.02 ;
...
createNode polyConnectComponents -n "polyConnectComponents27";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 12 "e[97]" "e[99]" "e[101]" "e[104]" "e[106]" "e[108]" "e[110]" "e[113]" "e[116]" "e[119]" "e[122]" "e[125]";
...
createNode deleteComponent -n "deleteComponent18";
	setAttr ".dc" -type "componentList" 1 "f[38:61]";
createNode polySewEdge -n "polySewEdge2";
	setAttr ".ics" -type "componentList" 9 "e[74]" "e[76]" "e[79]" "e[82]" "e[84]" "e[86]" "e[88]" "e[90]" "e[92:107]";
	setAttr ".ix" -type "matrix" 0.20000000000000001 0 0 0 0 0.20000000000000001 0 0
		 0 0 0.20000000000000001 0 -0.018777912775884035 -5.9604644775390628e-009 0 1;
	setAttr ".ws" yes;
createNode polyMergeVert -n "polyMergeVert11";
	setAttr ".ics" -type "componentList" 1 "vtx[48:71]";
	setAttr ".ix" -type "matrix" 0.20000000000000001 0 0 0 0 0.20000000000000001 0 0
		 0 0 0.20000000000000001 0 -0.018777912775884035 -5.9604644775390628e-009 0 1;
	setAttr ".am" yes;
...
createNode polyMapCut -n "polyMapCut5";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 3 "e[26]" "e[85]" "e[111]";
createNode polyMapCut -n "polyMapCut6";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 1 "e[81]";
createNode polyMapCut -n "polyMapCut7";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 3 "e[24]" "e[81]" "e[107]";
createNode polyTweakUV -n "polyTweakUV15";
	setAttr ".uopa" yes;
	setAttr -s 19 ".uvtk";
	setAttr ".uvtk[14]" -type "float2" -0.19734529 0.00077470392 ;
	setAttr ".uvtk[16]" -type "float2" -1.4480911 0.00077470392 ;
	setAttr ".uvtk[17]" -type "float2" -1.455654 0.00077469647 ;
	setAttr ".uvtk[21]" -type "float2" -2.7040625 0.00077470392 ;
	setAttr ".uvtk[83]" -type "float2" -0.19734529 0.00077470392 ;
	setAttr ".uvtk[86]" -type "float2" -1.4480911 0.00077470392 ;
	setAttr ".uvtk[101]" -type "float2" -1.455654 0.00077469891 ;
	setAttr ".uvtk[102]" -type "float2" -0.20490828 0.00077469647 ;
	setAttr ".uvtk[109]" -type "float2" -0.20490828 0.00077469647 ;
	setAttr ".uvtk[111]" -type "float2" -1.455654 0.00077469891 ;
	setAttr ".uvtk[122]" -type "float2" -0.20490828 0.00077470019 ;
	setAttr ".uvtk[123]" -type "float2" -1.455654 0.00077469647 ;
	setAttr ".uvtk[128]" -type "float2" -2.7040625 0.00077470019 ;
	setAttr ".uvtk[129]" -type "float2" -2.6964993 0.00077470392 ;
	setAttr ".uvtk[130]" -type "float2" -2.7040625 0.00077469752 ;
	setAttr ".uvtk[131]" -type "float2" -2.7040625 0.00077469752 ;
	setAttr ".uvtk[132]" -type "float2" -2.6964993 0.00077470392 ;
	setAttr ".uvtk[139]" -type "float2" -0.20490828 0.00077470392 ;
createNode polyNormal -n "polyNormal2";
	setAttr ".ics" -type "componentList" 3 "f[4:5]" "f[30:31]" "f[44:45]";
	setAttr ".unm" no;
createNode polyTweakUV -n "polyTweakUV16";
	setAttr ".uopa" yes;
	setAttr -s 19 ".uvtk";
	setAttr ".uvtk[14]" -type "float2" 0.15111399 0 ;
	setAttr ".uvtk[16]" -type "float2" 0.00031471252 0 ;
	setAttr ".uvtk[17]" -type "float2" -0.00059700012 0 ;
	setAttr ".uvtk[21]" -type "float2" -0.15111423 0 ;
	setAttr ".uvtk[83]" -type "float2" 0.15111399 0 ;
	setAttr ".uvtk[86]" -type "float2" 0.00031471252 0 ;
	setAttr ".uvtk[101]" -type "float2" -0.00059700012 0 ;
	setAttr ".uvtk[102]" -type "float2" 0.15020227 0 ;
	setAttr ".uvtk[109]" -type "float2" 0.15020227 0 ;
	setAttr ".uvtk[111]" -type "float2" -0.00059700012 0 ;
	setAttr ".uvtk[122]" -type "float2" 0.15020227 0 ;
	setAttr ".uvtk[123]" -type "float2" -0.00059700012 0 ;
	setAttr ".uvtk[128]" -type "float2" -0.15111423 0 ;
	setAttr ".uvtk[129]" -type "float2" -0.15020275 0 ;
	setAttr ".uvtk[130]" -type "float2" -0.15111423 0 ;
	setAttr ".uvtk[131]" -type "float2" -0.15111423 0 ;
	setAttr ".uvtk[132]" -type "float2" -0.15020275 0 ;
	setAttr ".uvtk[139]" -type "float2" 0.15020227 0 ;
...
createNode polyMergeVert -n "polyMergeVert13";
	setAttr ".ics" -type "componentList" 4 "vtx[5:6]" "vtx[15:16]" "vtx[56]" "vtx[68]";
	setAttr ".ix" -type "matrix" 0.20000000000000001 0 0 0 0 0.20000000000000001 0 0
		 0 0 0.20000000000000001 0 -0.018777912775884035 -5.9604644775390628e-009 0 1;
	setAttr ".am" yes;
createNode polyExtrudeEdge -n "polyExtrudeEdge13";
	...
	setAttr ".ix" -type "matrix" 0.20000000000000001 0 0 0 0 0.20000000000000001 0 0
		 0 0 0.20000000000000001 0 -0.018777912775884035 -5.9604644775390628e-009 0 1;
	setAttr ".ws" yes;
	setAttr ".pvt" -type "float3" 0.031000216 0.12100671 0.27500001 ;
	setAttr ".rs" 59100;
	setAttr ".lt" -type "double3" 1.1143736526776712e-016 -6.6786853825107073e-017 0.15940590154822293 ;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -0.48047215334595239 0.019312143325805668 0.275 ;
	setAttr ".cbx" -type "double3" 0.54247258313476054 0.22270128130912781 0.275 ;
createNode polyMergeVert -n "polyMergeVert14";
	setAttr ".ics" -type "componentList" 1 "vtx[72:83]";
	setAttr ".ix" -type "matrix" 0.20000000000000001 0 0 0 0 0.20000000000000001 0 0
		 0 0 0.20000000000000001 0 -0.018777912775884035 -5.9604644775390628e-009 0 1;
createNode polyTweak -n "polyTweak33";
	setAttr ".uopa" yes;
	setAttr -s 53 ".tk";
	setAttr ".tk[72]" -type "float3" -2.2646816 0.10383241 -0.010914803 ;
	setAttr ".tk[73]" -type "float3" -2.3884473 0.30134565 -0.013211012 ;
	setAttr ".tk[74]" -type "float3" 0.92078197 -0.10305063 -0.014732122 ;
	setAttr ".tk[75]" -type "float3" 1.0251524 -0.12933461 -0.01458478 ;
	setAttr ".tk[76]" -type "float3" 1.0641096 -0.071822092 -0.014320374 ;
	setAttr ".tk[77]" -type "float3" 1.5785794 0.21285941 -0.012359619 ;
	setAttr ".tk[78]" -type "float3" 2.2689223 0.21852098 0.025008559 ;
	setAttr ".tk[79]" -type "float3" 2.6748166 0.58123082 0.061885118 ;
	setAttr ".tk[80]" -type "float3" 2.1017218 0.10178237 0.024285436 ;
	setAttr ".tk[81]" -type "float3" -2.532557 -0.67060781 -0.012170911 ;
	setAttr ".tk[82]" -type "float3" -2.3504224 -0.41008914 -0.009326458 ;
	setAttr ".tk[83]" -type "float3" -2.0979767 -0.13466738 -0.0095585585 ;
...
createNode deleteComponent -n "deleteComponent19";
	setAttr ".dc" -type "componentList" 2 "e[120:121]" "e[127:128]";
...
createNode polyConnectComponents -n "polyConnectComponents30";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 2 "vtx[62]" "vtx[70:71]";
...
createNode polyPlanarProj -n "polyPlanarProj1";
	...
	setAttr ".ix" -type "matrix" 0.20000000000000001 0 0 0 0 0.20000000000000001 0 0
		 0 0 0.20000000000000001 0 -0.018777912775884035 -5.9604644775390628e-009 0 1;
	setAttr ".ws" yes;
	setAttr ".pc" -type "double3" 0.030982170253992081 0.12112906575202942 0.27500000596046448 ;
	setAttr ".ro" -type "double3" -1.1622392865614489e-005 -1.1618307256612466e-005 
		-89.97985532717054 ;
	setAttr ".ps" -type "double2" 0.20331247687041204 1.0229467008495081 ;
...
createNode polyTweakUV -n "polyTweakUV17";
	setAttr ".uopa" yes;
	setAttr -s 4 ".uvtk";
	setAttr ".uvtk[146]" -type "float2" 0 -0.026270431 ;
	setAttr ".uvtk[147]" -type "float2" 0 -0.05300412 ;
	setAttr ".uvtk[148]" -type "float2" 0 0.05300412 ;
createNode polyMapSewMove -n "polyMapSewMove15";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 1 "e[124]";
	setAttr ".lps" yes;
createNode polyMergeVert -n "polyMergeVert16";
	setAttr ".ics" -type "componentList" 8 "vtx[4]" "vtx[6]" "vtx[14]" "vtx[16]" "vtx[54]" "vtx[56]" "vtx[66]" "vtx[68]";
	setAttr ".ix" -type "matrix" 0.20000000000000001 0 0 0 0 0.20000000000000001 0 0
		 0 0 0.20000000000000001 0 -0.018777912775884035 -5.9604644775390628e-009 0 1;
	setAttr ".am" yes;
...
createNode polyChipOff -n "polyChipOff3";
	setAttr ".ics" -type "componentList" 7 "f[3:6]" "f[10]" "f[15:18]" "f[22]" "f[28:32]" "f[36:40]" "f[42]";
	setAttr ".ix" -type "matrix" 0.20000000000000001 0 0 0 0 0.20000000000000001 0 0
		 0 0 0.20000000000000001 0 -0.018777912775884035 -5.9604644775390628e-009 0 1;
	setAttr ".ws" yes;
	setAttr ".pvt" -type "float3" -0.018777912 -5.9604646e-009 0 ;
...
createNode polyMergeVert -n "polyMergeVert17";
	setAttr ".ics" -type "componentList" 2 "vtx[54]" "vtx[75]";
	setAttr ".ix" -type "matrix" 0.20000000000000001 0 0 0 0 0.20000000000000001 0 0
		 0 0 0.20000000000000001 0 -0.018777912775884035 -5.9604644775390628e-009 0 1;
	setAttr ".am" yes;
...
createNode polyTweakUV -n "polyTweakUV18";
	setAttr ".uopa" yes;
	setAttr -s 25 ".uvtk";
	setAttr ".uvtk[57]" -type "float2" -0.77973711 -0.37604117 ;
	setAttr ".uvtk[58]" -type "float2" 0.09736158 0.10561462 ;
	setAttr ".uvtk[59]" -type "float2" 0.12996903 0.15185438 ;
	setAttr ".uvtk[60]" -type "float2" 0.097071916 0.20864131 ;
	setAttr ".uvtk[61]" -type "float2" 0.038155317 0.24056421 ;
	setAttr ".uvtk[62]" -type "float2" -0.018839739 0.21629581 ;
	setAttr ".uvtk[63]" -type "float2" -0.8465237 -0.81306118 ;
	setAttr ".uvtk[83]" -type "float2" -0.77973711 -0.37604117 ;
	setAttr ".uvtk[84]" -type "float2" -0.8420803 -0.44382137 ;
	setAttr ".uvtk[112]" -type "float2" -0.7939682 -0.78634208 ;
	setAttr ".uvtk[113]" -type "float2" 0.09736158 0.10561462 ;
	setAttr ".uvtk[114]" -type "float2" -0.77973711 -0.37604117 ;
	setAttr ".uvtk[115]" -type "float2" -0.8420803 -0.44382137 ;
	setAttr ".uvtk[116]" -type "float2" -0.7939682 -0.78634208 ;
	setAttr ".uvtk[117]" -type "float2" -0.86517066 -0.51478428 ;
	setAttr ".uvtk[118]" -type "float2" -0.7939682 -0.78634208 ;
	setAttr ".uvtk[119]" -type "float2" -0.86517066 -0.51478428 ;
	setAttr ".uvtk[120]" -type "float2" -0.91058689 -0.73619854 ;
	setAttr ".uvtk[121]" -type "float2" -0.7939682 -0.78634208 ;
	setAttr ".uvtk[122]" -type "float2" -0.91058689 -0.73619854 ;
	setAttr ".uvtk[123]" -type "float2" -0.89332885 -0.79299015 ;
	setAttr ".uvtk[124]" -type "float2" -0.7939682 -0.78634208 ;
	setAttr ".uvtk[125]" -type "float2" -0.89332885 -0.79299015 ;
	setAttr ".uvtk[126]" -type "float2" -0.7939682 -0.78634208 ;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
connectAttr "polyAutoProj2.out" "pasted__turretShape.i";
connectAttr "polyTweakUV18.out" "pasted__treadsShape.i";
connectAttr "polyTweakUV18.uvtk[0]" "pasted__treadsShape.uvst[0].uvtw";
connectAttr "polyAutoProj4.out" "pasted__chassisShape.i";
...
connectAttr "pasted__polyCloseBorder4.out" "polyAutoProj2.ip";
connectAttr "pasted__turretShape.wm" "polyAutoProj2.mp";
connectAttr "pasted__transformGeometry2.og" "polyAutoProj3.ip";
connectAttr "pasted__treadsShape.wm" "polyAutoProj3.mp";
connectAttr "polySoftEdge13.out" "polyAutoProj4.ip";
connectAttr "pasted__chassisShape.wm" "polyAutoProj4.mp";
...
connectAttr "pasted__chassisShape.iog" "blinn2SG.dsm" -na;
connectAttr "pasted__treadsShape.iog" "blinn2SG.dsm" -na;
connectAttr "pasted__turretShape.iog" "blinn2SG.dsm" -na;
...
connectAttr "polyTweakUV11.out" "polySoftEdge14.ip";
connectAttr "pasted__treadsShape.wm" "polySoftEdge14.mp";
connectAttr "polySoftEdge14.out" "polySoftEdge15.ip";
connectAttr "pasted__treadsShape.wm" "polySoftEdge15.mp";
connectAttr "polySoftEdge15.out" "polySoftEdge16.ip";
connectAttr "pasted__treadsShape.wm" "polySoftEdge16.mp";
connectAttr "polySoftEdge16.out" "polySoftEdge17.ip";
connectAttr "pasted__treadsShape.wm" "polySoftEdge17.mp";
connectAttr "polySoftEdge17.out" "polySoftEdge18.ip";
connectAttr "pasted__treadsShape.wm" "polySoftEdge18.mp";
connectAttr "polySoftEdge18.out" "polySoftEdge19.ip";
connectAttr "pasted__treadsShape.wm" "polySoftEdge19.mp";
connectAttr "polySoftEdge19.out" "polySoftEdge20.ip";
connectAttr "pasted__treadsShape.wm" "polySoftEdge20.mp";
connectAttr "polySoftEdge20.out" "polyExtrudeFace2.ip";
connectAttr "pasted__treadsShape.wm" "polyExtrudeFace2.mp";
connectAttr "polyExtrudeFace2.out" "polyExtrudeFace3.ip";
connectAttr "pasted__treadsShape.wm" "polyExtrudeFace3.mp";
connectAttr "polyExtrudeFace3.out" "deleteComponent16.ig";
connectAttr "deleteComponent16.og" "deleteComponent17.ig";
connectAttr "deleteComponent17.og" "polyExtrudeEdge12.ip";
connectAttr "pasted__treadsShape.wm" "polyExtrudeEdge12.mp";
connectAttr "polyExtrudeEdge12.out" "polyNormalizeUV1.ip";
connectAttr "pasted__treadsShape.wm" "polyNormalizeUV1.mp";
connectAttr "polyNormalizeUV1.out" "polyAutoProj5.ip";
connectAttr "pasted__treadsShape.wm" "polyAutoProj5.mp";
connectAttr "polyAutoProj5.out" "polyTweakUV12.ip";
connectAttr "polyTweakUV12.out" "polyMapCut3.ip";
connectAttr "polyMapCut3.out" "polyMapSewMove9.ip";
connectAttr "polyMapSewMove9.out" "polyMapSewMove10.ip";
connectAttr "polyMapSewMove10.out" "polyTweakUV13.ip";
connectAttr "polyTweakUV13.out" "polyMapSewMove11.ip";
connectAttr "polyMapSewMove11.out" "polyMergeUV1.ip";
connectAttr "polyMergeUV1.out" "polyMapCut4.ip";
connectAttr "polyMapCut4.out" "polyTweakUV14.ip";
connectAttr "polyTweakUV14.out" "polyChipOff2.ip";
connectAttr "pasted__treadsShape.wm" "polyChipOff2.mp";
connectAttr "polyChipOff2.out" "polyNormal1.ip";
connectAttr "polyNormal1.out" "polyConnectComponents27.ip";
connectAttr "polyConnectComponents27.out" "polyConnectComponents28.ip";
connectAttr "polyConnectComponents28.out" "deleteComponent18.ig";
connectAttr "deleteComponent18.og" "polySewEdge2.ip";
connectAttr "pasted__treadsShape.wm" "polySewEdge2.mp";
connectAttr "polySewEdge2.out" "polyMergeVert11.ip";
connectAttr "pasted__treadsShape.wm" "polyMergeVert11.mp";
connectAttr "polyMergeVert11.out" "polyMergeVert12.ip";
connectAttr "pasted__treadsShape.wm" "polyMergeVert12.mp";
connectAttr "polyMergeVert12.out" "polyMapCut5.ip";
connectAttr "polyMapCut5.out" "polyMapCut6.ip";
connectAttr "polyMapCut6.out" "polyMapCut7.ip";
connectAttr "polyMapCut7.out" "polyTweakUV15.ip";
connectAttr "polyTweakUV15.out" "polyNormal2.ip";
connectAttr "polyNormal2.out" "polyTweakUV16.ip";
...
connectAttr "polyMapSewMove14.out" "polyMergeVert13.ip";
connectAttr "pasted__treadsShape.wm" "polyMergeVert13.mp";
connectAttr "polyMergeVert13.out" "polyExtrudeEdge13.ip";
connectAttr "pasted__treadsShape.wm" "polyExtrudeEdge13.mp";
connectAttr "polyTweak33.out" "polyMergeVert14.ip";
connectAttr "pasted__treadsShape.wm" "polyMergeVert14.mp";
connectAttr "polyExtrudeEdge13.out" "polyTweak33.ip";
connectAttr "polyMergeVert14.out" "polyMergeVert15.ip";
connectAttr "pasted__treadsShape.wm" "polyMergeVert15.mp";
connectAttr "polyMergeVert15.out" "deleteComponent19.ig";
connectAttr "deleteComponent19.og" "polyConnectComponents29.ip";
...
connectAttr "polyConnectComponents31.out" "polyPlanarProj1.ip";
connectAttr "pasted__treadsShape.wm" "polyPlanarProj1.mp";
connectAttr "polyPlanarProj1.out" "polyNormalizeUV2.ip";
connectAttr "pasted__treadsShape.wm" "polyNormalizeUV2.mp";
connectAttr "polyNormalizeUV2.out" "polyNormalizeUV3.ip";
connectAttr "pasted__treadsShape.wm" "polyNormalizeUV3.mp";
connectAttr "polyNormalizeUV3.out" "polyAutoProj6.ip";
connectAttr "pasted__treadsShape.wm" "polyAutoProj6.mp";
connectAttr "polyAutoProj6.out" "polyTweakUV17.ip";
connectAttr "polyTweakUV17.out" "polyMapSewMove15.ip";
connectAttr "polyMapSewMove15.out" "polyMergeVert16.ip";
connectAttr "pasted__treadsShape.wm" "polyMergeVert16.mp";
connectAttr "polyMergeVert16.out" "deleteComponent20.ig";
connectAttr "deleteComponent20.og" "polyChipOff3.ip";
connectAttr "pasted__treadsShape.wm" "polyChipOff3.mp";
connectAttr "polyChipOff3.out" "polyChipOff4.ip";
connectAttr "pasted__treadsShape.wm" "polyChipOff4.mp";
connectAttr "polyChipOff4.out" "polyChipOff5.ip";
connectAttr "pasted__treadsShape.wm" "polyChipOff5.mp";
connectAttr "polyChipOff5.out" "polyChipOff6.ip";
connectAttr "pasted__treadsShape.wm" "polyChipOff6.mp";
connectAttr "polyChipOff6.out" "polyChipOff7.ip";
connectAttr "pasted__treadsShape.wm" "polyChipOff7.mp";
connectAttr "polyChipOff7.out" "polyChipOff8.ip";
connectAttr "pasted__treadsShape.wm" "polyChipOff8.mp";
connectAttr "polyChipOff8.out" "polyChipOff9.ip";
connectAttr "pasted__treadsShape.wm" "polyChipOff9.mp";
connectAttr "polyChipOff9.out" "polyChipOff10.ip";
connectAttr "pasted__treadsShape.wm" "polyChipOff10.mp";
connectAttr "polyChipOff10.out" "polyChipOff11.ip";
connectAttr "pasted__treadsShape.wm" "polyChipOff11.mp";
connectAttr "polyChipOff11.out" "polyChipOff12.ip";
connectAttr "pasted__treadsShape.wm" "polyChipOff12.mp";
connectAttr "polyChipOff12.out" "polyChipOff13.ip";
connectAttr "pasted__treadsShape.wm" "polyChipOff13.mp";
connectAttr "polyChipOff13.out" "polyChipOff14.ip";
connectAttr "pasted__treadsShape.wm" "polyChipOff14.mp";
connectAttr "polyChipOff14.out" "polyMergeVert17.ip";
connectAttr "pasted__treadsShape.wm" "polyMergeVert17.mp";
connectAttr "polyMergeVert17.out" "polyChipOff15.ip";
connectAttr "pasted__treadsShape.wm" "polyChipOff15.mp";
connectAttr "polyChipOff15.out" "polyChipOff16.ip";
connectAttr "pasted__treadsShape.wm" "polyChipOff16.mp";
connectAttr "polyChipOff16.out" "polyChipOff17.ip";
connectAttr "pasted__treadsShape.wm" "polyChipOff17.mp";
connectAttr "polyChipOff17.out" "polyChipOff18.ip";
connectAttr "pasted__treadsShape.wm" "polyChipOff18.mp";
connectAttr "polyChipOff18.out" "polyChipOff19.ip";
connectAttr "pasted__treadsShape.wm" "polyChipOff19.mp";
connectAttr "polyChipOff19.out" "polyChipOff20.ip";
connectAttr "pasted__treadsShape.wm" "polyChipOff20.mp";
connectAttr "polyChipOff20.out" "polyChipOff21.ip";
connectAttr "pasted__treadsShape.wm" "polyChipOff21.mp";
connectAttr "polyChipOff21.out" "polyChipOff22.ip";
connectAttr "pasted__treadsShape.wm" "polyChipOff22.mp";
connectAttr "polyChipOff22.out" "polyNormal3.ip";
...
connectAttr "polyNormal8.out" "polyMergeVert18.ip";
connectAttr "pasted__treadsShape.wm" "polyMergeVert18.mp";
connectAttr "polyMergeVert18.out" "polyMergeVert19.ip";
connectAttr "pasted__treadsShape.wm" "polyMergeVert19.mp";
